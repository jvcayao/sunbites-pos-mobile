...
const item2 = makeItem({ id: 2, name: 'Juice Box',    price: 25, category: 'drink' })
...
describe('useCartStore — student / walk-in', () => {
  it('sets the active student', () => {
    const student = { id: 1, full_name: 'Maria Santos', student_number: 'ANT-001', grade_level: 'Grade 3', wallet_balance: 500, credit_balance: 0 }
