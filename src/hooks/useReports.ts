...
export function useSalesReport(params: Omit<SalesReportParams, "page">) {
  return useInfiniteQuery({
    ...
    queryFn: ({ pageParam = 1 }) =>
      reportsApi
        .sales({ ...params, page: pageParam as number })
        .then((r) => r.data as SalesReportResponse),
...
export function useStudentsReport(params: Omit<StudentsReportParams, "page">) {
  return useInfiniteQuery({
    ...
    queryFn: ({ pageParam = 1 }) =>
      reportsApi
        .students({ ...params, page: pageParam as number })
        .then((r) => r.data),
...
export function useWalletReport(params: Omit<WalletReportParams, "page">) {
  return useInfiniteQuery({
    ...
    queryFn: ({ pageParam = 1 }) =>
      reportsApi
        .wallet({ ...params, page: pageParam as number })
        .then((r) => r.data),
    getNextPageParam: (last: any) =>
      last.meta?.page < last.meta?.last_page ? last.meta.page + 1 : undefined,
    initialPageParam: 1,
...
export function useBillingReport(params: Omit<BillingReportParams, "page">) {
  return useInfiniteQuery({
    ...
    queryFn: ({ pageParam = 1 }) =>
      reportsApi
        .billing({ ...params, page: pageParam as number })
        .then((r) => r.data),
    getNextPageParam: (last: any) =>
      last.meta?.page < last.meta?.last_page ? last.meta.page + 1 : undefined,
    initialPageParam: 1,
...
export function useCreditsReport(params: Omit<CreditsReportParams, "page">) {
  return useInfiniteQuery({
    ...
    queryFn: ({ pageParam = 1 }) =>
      reportsApi
        .credits({ ...params, page: pageParam as number })
        .then((r) => r.data),
    getNextPageParam: (last: any) =>
      last.meta?.page < last.meta?.last_page ? last.meta.page + 1 : undefined,
    initialPageParam: 1,
...
export function useActivityLog(params: Omit<ActivityReportParams, "page">) {
  return useInfiniteQuery({
    ...
    queryFn: ({ pageParam = 1 }) =>
      reportsApi
        .activity({ ...params, page: pageParam as number })
        .then((r) => r.data),
    getNextPageParam: (last: any) =>
      last.meta?.page < last.meta?.last_page ? last.meta.page + 1 : undefined,
    initialPageParam: 1,
