...
export function useCreateInventoryItem() {
  ...
  return useMutation({
    ...
    onSuccess: () =>
      qc.invalidateQueries({ queryKey: ["references", "inventory"] }),
  });
}
...
export function useUpdateInventoryItem() {
  ...
  return useMutation({
    mutationFn: ({ id, data }: { id: number; data: object }) =>
      referencesApi.inventory.update(id, data),
    onSuccess: () =>
      qc.invalidateQueries({ queryKey: ["references", "inventory"] }),
  });
}
...
export function useMealPlanner(month: SchoolMonth, week: number) {
  return useQuery({
    ...
    queryFn: () =>
      referencesApi.mealPlanner.show(month, week).then((r) => r.data),
  });
}
...
export function useUpdateMealPlanner() {
  ...
  return useMutation({
    ...
    onSuccess: () =>
      qc.invalidateQueries({ queryKey: ["references", "meal-planner"] }),
  });
}
...
export function useUpdateMealPlannerVisibility() {
  ...
  return useMutation({
    mutationFn: (data: object) =>
      referencesApi.mealPlanner.updateVisibility(data),
    onSuccess: () =>
      qc.invalidateQueries({ queryKey: ["references", "meal-planner"] }),
  });
}
...
export function useCreateUser() {
  ...
  return useMutation({
    ...
    onSuccess: () =>
      qc.invalidateQueries({ queryKey: ["references", "users"] }),
  });
}
...
export function useDeactivateUser(id: number) {
  ...
  return useMutation({
    ...
    onSuccess: () =>
      qc.invalidateQueries({ queryKey: ["references", "user", id] }),
  });
}
...
export function useUpdateBranch() {
  ...
  return useMutation({
    mutationFn: ({ id, data }: { id: number; data: object }) =>
      referencesApi.branches.update(id, data),
    onSuccess: () =>
      qc.invalidateQueries({ queryKey: ["references", "branches"] }),
  });
}
...
export function useMonthlyAmounts(year: number) {
  return useQuery({
    ...
    queryFn: () =>
      referencesApi.subscriptionConfig
        .getMonthlyAmounts(year)
        .then((r) => r.data),
  });
}
...
export function useUpdateSystemSetting() {
  ...
  return useMutation({
    ...
    onSuccess: () =>
      qc.invalidateQueries({ queryKey: ["references", "system-settings"] }),
  });
}
...
export function useMarkFeedbackRead() {
  ...
  return useMutation({
    ...
    onSuccess: () =>
      qc.invalidateQueries({ queryKey: ["references", "feedback"] }),
  });
}
...
export function useReplyToFeedback() {
  ...
  return useMutation({
    mutationFn: ({ id, message }: { id: number; message: string }) =>
      referencesApi.feedback.reply(id, message),
    onSuccess: () =>
      qc.invalidateQueries({ queryKey: ["references", "feedback"] }),
  });
}
