...
describe("RecipientTypePill", () => {
  it("renders Parents and Staff options", () => {
    render(<RecipientTypePill value="parents" onChange={jest.fn()} />, {
      wrapper: Wrapper,
    });
  ...
  it("calls onChange with parents when Parents is pressed", () => {
    ...
    render(<RecipientTypePill value="staff" onChange={onChange} />, {
      wrapper: Wrapper,
    });
  ...
  it("calls onChange with staff when Staff is pressed", () => {
    const onChange = jest.fn();
    render(<RecipientTypePill value="parents" onChange={onChange} />, {
      wrapper: Wrapper,
    });
