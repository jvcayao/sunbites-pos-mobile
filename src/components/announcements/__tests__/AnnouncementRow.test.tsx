...
describe('AnnouncementRow', () => {
  it('displays sender name', () => {
    render(<AnnouncementRow announcement={parentsAnnouncement} onPress={jest.fn()} />)
  ...
  it('shows Staff badge for staff recipient type', () => {
    render(<AnnouncementRow announcement={staffAnnouncement} onPress={jest.fn()} />)
    expect(screen.getByText('Staff')).toBeTruthy()
  })

  it('calls onPress when row is tapped', () => {
    const onPress = jest.fn()
    render(<AnnouncementRow announcement={parentsAnnouncement} onPress={onPress} />)
