          ...
          <Surface style={styles.surface} elevation={4}>
            ...
            <View style={styles.body}>
              ...
              <View style={styles.monthSection}>
                <Text variant="labelSmall" style={styles.colLabel}>
                  Month
                </Text>
                <ScrollView
                ...
                >
                  {MONTHS.map((m, idx) => (
                    <Pressable
                      ...
                      style={[
                        styles.monthRow,
                        selectedMonth === idx + 1 && styles.monthRowActive,
                      ]}
                      accessibilityRole="button"
                      accessibilityLabel={m}
                      accessibilityState={{
                        selected: selectedMonth === idx + 1,
                      }}
                    >
                      <Text
                        variant="bodyMedium"
              ...
              <View style={styles.numericSection}>
                ...
                <Text
                  variant="labelSmall"
                  style={[styles.colLabel, styles.yearLabel]}
                >
                  Year
                </Text>
                <TextInput
            ...
            <View style={styles.footer}>
              <Button onPress={() => setOpen(false)} accessibilityRole="button">
                Cancel
              </Button>
              <Button
