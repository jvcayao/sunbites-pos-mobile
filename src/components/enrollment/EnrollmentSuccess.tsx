...
export function EnrollmentSuccess({ student, onEnrollAnother }: EnrollmentSuccessProps) {
  ...
  return (
    <View style={styles.container}>
      ...
      />
      <Text variant="headlineSmall" style={styles.heading}>Enrollment Successful!</Text>

      <Surface style={styles.card} elevation={1}>
        <View style={styles.row}>
          <Text variant="labelSmall" style={styles.key}>Full Name</Text>
          <Text variant="bodyMedium" style={styles.val}>{student.full_name}</Text>
        </View>
        <View style={styles.row}>
          <Text variant="labelSmall" style={styles.key}>Student #</Text>
          <Text variant="bodyMedium" style={styles.val}>{student.student_number}</Text>
        </View>
        <View style={styles.row}>
          <Text variant="labelSmall" style={styles.key}>Type</Text>
          <Text variant="bodyMedium" style={styles.val}>
            {student.student_type === 'subscription' ? 'Subscription' : 'Non-Subscription'}
          </Text>
        </View>
        <View style={styles.row}>
          <Text variant="labelSmall" style={styles.key}>Enrolled</Text>
          <Text variant="bodyMedium" style={styles.val}>
