...
import { Button, Divider, Modal, Portal, Surface, Text, TouchableRipple } from 'react-native-paper'
import { palette } from '@/theme'
import type { StaffStatus } from '@/types/dashboard'

const STATUSES: Array<{ key: StaffStatus; label: string; color: string }> = [
        ...
        <Surface style={styles.surface} elevation={4}>
          ...
          {STATUSES.map((s) => (
            <TouchableRipple
              ...
              disabled={loading}
              style={[styles.option, currentStatus === s.key && styles.optionActive]}
            ...
            >
              <View style={styles.optionRow}>
                ...
                <Text
                  variant="bodyLarge"
                  style={currentStatus === s.key ? styles.activeText : styles.optionText}
                >
                  {s.label}
                </Text>
              </View>
