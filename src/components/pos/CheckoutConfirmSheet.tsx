...
export function CheckoutConfirmSheet({
  ...
  const change =
    amountTendered !== undefined ? amountTendered - total : undefined;
          ...
          <View style={styles.body}>
            ...
            {discountAmount > 0 && (
              <View style={styles.row}>
                ...
                <Text
                  variant="bodyMedium"
                  style={[styles.val, styles.discount]}
                >
            ...
            <View style={[styles.row, styles.totalRow]}>
              <Text variant="titleMedium" style={styles.totalKey}>
                Total
              </Text>
              <Text variant="titleMedium" style={styles.totalVal}>
            ...
            <View style={styles.row}>
              ...
              <Text variant="bodyMedium" style={[styles.val, styles.method]}>
                {paymentMethod}
              </Text>
            </View>
