  ...
  if (isWalkIn) {
    return (
      <View style={styles.walkInBanner}>
        <Text variant="bodyMedium" style={styles.walkInText}>
          Walk-in Customer
        </Text>
        <Pressable
          onPress={onClearStudent}
        ...
        >
          <Text variant="labelSmall" style={styles.walkInChangeText}>
            Change
          </Text>
        </Pressable>
      </View>
      ...
      <TextInput
        ...
        right={
          isPending ? (
            <TextInput.Icon
              icon={() => (
                <ActivityIndicator size={16} color={palette.orange500} />
              )}
            />
          ) : (
            ...
            return (
              <View key={student.id}>
                ...
                >
                  <Text
                    variant="bodyMedium"
                    style={!isEnrolled ? styles.disabledText : undefined}
                  >
                    {!isEnrolled && "⛔ "}
                    {student.full_name}
                  </Text>
