...
export const referencesApi = {
  ...
  inventory: {
    ...
    update:    (id: number, data: object) => client.put(`/references/inventory/${id}`, data),
    destroy:   (id: number)      => client.delete(`/references/inventory/${id}`),
    archive:   (id: number)      => client.patch(`/references/inventory/${id}/archive`),
    unarchive: (id: number)      => client.patch(`/references/inventory/${id}/unarchive`),
    logs:      (id: number)      => client.get(`/references/inventory/${id}/logs`),
    history:   (params?: object) => client.get('/references/inventory/history', { params }),
  },
  ...
  mealPlanner: {
    ...
    update:           (data: object) =>
      client.patch('/references/meal-planner', data),
    reset:            (data: object) =>
  ...
  subscriptionConfig: {
    getMonthlyAmounts: (year: number)           => client.get('/branch-monthly-amounts', { params: { year } }),
    createAmount:      (data: object)           => client.post('/branch-monthly-amounts', data),
    updateAmount:      (id: number, data: object) => client.put(`/branch-monthly-amounts/${id}`, data),
    deleteAmount:      (id: number)             => client.delete(`/branch-monthly-amounts/${id}`),
  ...
  parents: {
    ...
    resendActivation: (id: number)      => client.post(`/references/parents/${id}/resend-activation`),
  },
