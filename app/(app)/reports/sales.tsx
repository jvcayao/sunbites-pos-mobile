...
export default function SalesReportScreen() {
  ...
  const params = {
    ...
    payment_method:
      payment === "all" ? undefined : (payment as OrderPaymentMethod),
  ...
  const renderItem = useCallback(
    ({ item }: { item: SalesReportItem }) => (
      <View style={[listCardStyle, styles.row]}>
        <View style={styles.left}>
          <Text variant="labelSmall" style={styles.receipt}>
            {item.receipt_number}
          </Text>
          <Text variant="bodySmall" style={styles.meta}>
            {item.student_name ?? "Walk-in"} · {item.item_count} items
          </Text>
          <Text variant="bodySmall" style={styles.meta}>
  ...
  return (
    <View style={styles.container}>
      <AppHeader title="Sales Report" showBack />
      {isLoading ? (
        ...
        <>
          ...
          <FlatList
            ...
            ListEmptyComponent={
              <EmptyState icon="chart-bar" title="No sales data" />
            }
            ListFooterComponent={
              isFetchingNextPage ? (
