...
import { SCHOOL_MONTHS, listCardStyle } from "@/lib/constants";
...
export default function BillingReportScreen() {
  ...
  const params = {
    year,
    school_month: month === "all" ? undefined : month,
      ...
      <View style={[listCardStyle, styles.row]}>
        <View style={styles.left}>
          ...
          <Text variant="bodySmall" style={styles.meta}>
            {item.grade_level} · {item.school_month}
          </Text>
        </View>
  ...
  return (
    <View style={styles.container}>
      <AppHeader title="Billing Report" showBack />
      {isLoading ? (
        ...
        <>
          ...
          <FlatList
            ...
            ListEmptyComponent={
              <EmptyState icon="receipt" title="No billing data" />
            }
            ListFooterComponent={
              isFetchingNextPage ? (
