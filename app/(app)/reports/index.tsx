...
const REPORTS: ReportCard[] = [
  {
    title: "Sales",
    desc: "Orders, revenue, payment methods",
    icon: "cash-register",
    route: "sales",
  ...
  {
    title: "Students",
    desc: "Enrollment, grades, balances",
    icon: "account-group",
    route: "students",
  ...
  {
    title: "Wallet",
    desc: "Credits, debits, low balances",
    icon: "wallet",
    route: "wallet",
  ...
  {
    title: "Inventory",
    desc: "Stock levels, adjustments, history",
  ...
  {
    title: "Billing",
    desc: "Subscription payments, collection rate",
    icon: "receipt",
    route: "billing",
  ...
  {
    title: "Credits",
    desc: "Outstanding credit audit trail",
    icon: "alert-circle",
    route: "credits",
  ...
  {
    title: "Activity Log",
    desc: "System-wide activity history",
    icon: "history",
    route: "activity",
  ...
  {
    title: "Daily Summary",
    desc: "End-of-day totals and breakdowns",
    icon: "calendar-today",
    route: "daily-summary",
    color: palette.blue500,
  },
