...
export default function WalletReportScreen() {
    ...
    return (
      <View style={[listCardStyle, styles.row]}>
        ...
        <View style={styles.right}>
          <Text
            variant="titleSmall"
            style={[styles.balance, isLow && styles.low]}
          >
            {formatCurrency(item.wallet_balance)}
          </Text>
          <Text variant="bodySmall" style={styles.meta}>
            +{formatCurrency(item.total_credited)}
          </Text>
        </View>
      </View>
    );
  ...
  return (
    <View style={styles.container}>
      <AppHeader title="Wallet Report" showBack />
      {isLoading ? (
        ...
        <>
          ...
          <FlatList
            ...
            ListEmptyComponent={
              <EmptyState icon="wallet" title="No wallet data" />
            }
            ListFooterComponent={
              isFetchingNextPage ? (
