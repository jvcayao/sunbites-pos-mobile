...
export default function ReferencesIndexScreen() {
  ...
  const SECTIONS: Section[] = (
    [
      {
        title: "Inventory",
        desc: "Stock items, adjustments, history",
      ...
      {
        title: "Users",
        desc: "Staff accounts and roles",
        icon: "account-multiple" as IconName,
        route: "users",
        visible: canUsers,
      },
      {
        title: "Branches",
        desc: "Branch settings and toggles",
      ...
      },
      {
        ...
        desc: "Monthly billing by branch",
      ...
      {
        title: "Parents",
        desc: "Parent contacts and portal",
        icon: "account-heart" as IconName,
        route: "parents",
        visible: true,
      },
      {
        title: "Feedback",
        desc: "Student and parent feedback",
        icon: "message-text" as IconName,
        route: "feedback",
        visible: true,
      },
      {
        title: "System Settings",
        desc: "Global configuration values",
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <Surface style={styles.card} elevation={1}>
            <TouchableRipple
              onPress={() =>
                router.push(`/(app)/references/${item.route}` as any)
              }
              borderless
              style={styles.ripple}
