...
const mockUseEligibleParents = useEligibleParents as jest.MockedFunction<
  typeof useEligibleParents
>;
const mockUseSendReminders = useSendReminders as jest.MockedFunction<
  typeof useSendReminders
>;
